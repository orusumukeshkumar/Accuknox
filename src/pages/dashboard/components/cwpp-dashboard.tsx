...
import { RootState, UpdateCWPPWidget } from '@/redux/store';
...
const CWPPDashboard = () => {
  ...
  return (
    ...
    {cwpp?.map((object: WidgetItemProps) => {
      if (object.isActive){
        return (
          <Card className="lg:h-[200px] md:h-[170px] sm:h-[100px]  border-4 border-gray-500  rounded-xl">
            ...
            <div className="flex flex-row ">
              ...
              <CardContent className="m-1 lg:text-2xl md:text-xl sm:text-md flex flex-row"><Sparkle className="h-5 w-5 mt-1 mr-1 text-blue-600 text-5xl"/> {object.widgetName}</CardContent>
