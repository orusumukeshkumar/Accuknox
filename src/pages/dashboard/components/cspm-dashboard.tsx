...
import { RootState, UpdateCSPMWidget } from "@/redux/store";
...
const CSPMDashboard = () => {
  ...
  return (
    <Card className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 gap-4 bg-transparent border-0 border-transparent">
        ...
        {cspm?.map((object: WidgetItemProps) => {
          if (object.isActive){
            return (
