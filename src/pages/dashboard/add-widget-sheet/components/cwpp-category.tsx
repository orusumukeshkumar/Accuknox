...
import { AddCWPPWidget,RootState,UpdateCWPPWidget } from "@/redux/store";
import { Check } from "lucide-react";
import { toast } from "@/components/ui/use-toast";
import { Schema } from "@/redux/dashboard/dashboard-types";


export default function CWPPCategory() {
  ...
  function onSubmit(data: z.infer<typeof Schema>) {
    dispatch(AddCWPPWidget({...data,isActive:true,category:'cwpp'}));
    toast({
      variant: "default",
  ...
  return (
    <div>
      ...
      {cwpp?.map((object: WidgetItemProps, index: number) => {
