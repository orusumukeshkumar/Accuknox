...
import { AddCSPMWidget, UpdateCSPMWidget, RootState } from "@/redux/store";
import { Check } from "lucide-react";
import {  useToast } from "@/components/ui/use-toast";
import { Schema } from "@/redux/dashboard/dashboard-types";


export default function CspmCategory() {
  ...
  function onSubmit(data: z.infer<typeof Schema>) {
    dispatch(AddCSPMWidget({...data, isActive: true,category:'cspm'}));
    toast({
      variant: "default",
  ...
  return (
    <div>
      ...
      {cspm?.map((object: WidgetItemProps, index: number) => {
